...
const mockAction: BinActionForm = {
...
function EditBinAction() {
  const navigate = useNavigate();
  const { id } = useParams();
  const [formData, setFormData] = useState<BinActionForm>(mockAction);

  useEffect(() => {
    // In a real application, fetch the action data using the ID
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">BIN Aksiyonu Düzenle</h1>
      </div>
